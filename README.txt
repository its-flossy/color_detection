...
4- Run the Exe file by using the following command:-
   ...
   My file name is "abcdef" and its format is JPG
   python Color_detection.py -i abcdef.jpg
5- Now select the area where you want to know the Color Name/RGB code.
